...
If you are setting up Scale Pay for the first time, go to [Import documents](../document-upload.md) next to learn how to add your invoices, purchase orders, and payment files.
